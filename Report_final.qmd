...
We deviated from the original theory in followed restrictions of our code: We assume that for our simulation, identifiability has so specific role cause we choose the "setting" to include no identifiability of the individual effort. This aligns with both of the replicated researches. Further, we don't include the multiplicative function of the social impact theory that describes the impact on a person: Immediacy and strength are not observed and held constant so only the number of Sources and Co-Targets ist relevant to the mechanism. These restrictions were necessary to once again secure understandability over completeness. As we're introduce later in this report, these weren't either crucial for our Model and replication of the loafing effect. 
